                        ...
                        >
                            <HeadlessDialogPanel
                                className={clsx(
                                    className,
                                    sizes[size],
                                    "row-start-2 w-full min-w-0 rounded-t-3xl bg-white p-[--gutter] shadow-lg ring-1 ring-grey-950/10 [--gutter:theme(spacing.8)] sm:mb-auto sm:rounded-2xl dark:bg-grey-950 dark:ring-white/10 forced-colors:outline"
                                )}
                            >
                                {children}
                            </HeadlessDialogPanel>
