        ...
        return (
            <span
                ...
                className={clsx([
                    ...
                    // Disabled state
                    "has-[[data-disabled]]:opacity-50 before:has-[[data-disabled]]:bg-grey-950/5 before:has-[[data-disabled]]:shadow-none",
                ])}
            >
                <HeadlessTextarea
                    ref={ref}
                    className={clsx([
                        ...
                        // Disabled state
                        "disabled:border-grey-950/20 disabled:dark:border-white/15 disabled:dark:bg-white/[2.5%] dark:data-[hover]:disabled:border-white/15",
